...
class FlightPrice(Base):
    ...
    flight_id = Column(INTEGER(unsigned=True), ForeignKey("flights.id"), nullable=False, unique=True)
    ticket_class_id = Column(INTEGER(unsigned=True), ForeignKey("ticket_classes.id"), nullable=False, unique=True)
